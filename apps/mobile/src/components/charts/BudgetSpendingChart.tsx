    ...
    <Animated.View entering={FadeInUp.delay(200).springify()} style={[styles.container, { backgroundColor: colors.surface, borderColor: colors.borderAlt }]}>
      ...
      <LineChart
        ...
        chartConfig={{
          ...
          propsForBackgroundLines: { stroke: colors.borderAlt || colors.border, strokeDasharray: '4', strokeOpacity: 0.5 },
        }}
        bezier
        style={styles.chart}
...
const styles = StyleSheet.create({
  container: { borderRadius: moderateScale(24), padding: moderateScale(16), borderWidth: 1, marginBottom: moderateScale(24) },
  title: { fontFamily: 'Inter-SemiBold', fontSize: moderateScale(16), marginBottom: moderateScale(12) },
